...
export default function MessageSelection(props: {
    ...
    return (
        <div className="body" {...props.divAttributes}>
            <h1 className="pt-[3em] bg-gray-100 text-black flex justify-center text-4xl font-extrabold">Message Selection</h1>
            <div className="bg-gray-100 w-screen text-black h-screen grid-cols-6 grid">
                ...
                <div
                    ...
                    onClick={() => props.nextFunc(EventType.Message)}
                >
                    Next
                </div>
            </div>
